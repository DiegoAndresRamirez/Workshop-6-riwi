...
#### Ejercicio 6: Event Loop y Web APIs
  ...
  **Reflexión y Análisis:** - ¿Por qué "Mensaje 2: Con timeout de 0 segundos" no se0 segundos? - ¿Que nos dicen este compo muestra inmediatamente después de "Mensaje 1: Inmediatamente", a pesar de tener un retardo de rtamiento sobre el event loop, las macro y micro tareas, y la forma en que JavaScript maneja las operaciones asíncronas?
